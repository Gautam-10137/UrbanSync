...
const Register = () => {
  ...
  return (
    <div>
    <div className="font-bold shadow hover:shadow-md hover:bg-blue-200 text-2xl border-2 text-center w-fit border-blue-500 rounded mx-auto mb-10 mt-6 p-4 h-16 flex items-center justify-center">
      UrbanSync
    </div>
